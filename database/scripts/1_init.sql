...
CREATE TABLE public.asset_absence_codes (
	id_asset_absence_code int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.asset_types (
	id_asset_type int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.clearing_type (
	id_clearing_type int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.config (
	id_config int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.countries (
	id_country int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
	country varchar(50) NOT NULL,
	country_code varchar(3) NOT NULL,
	emoji_code varchar(10) NULL,
	country_title varchar NULL,
...
CREATE TABLE public.currencies (
	id_currency int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.employee_absence_codes (
	id_employee_absence_code int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.employee_types (
	id_employee_type int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.invoice_states (
	id_invoice_state int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.invoice_terms (
	id_invoice_term int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.sales_state (
	id_sales_state int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.sys_rec_states (
	id_sys_rec_status int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.task_states (
	id_task_state int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.template_types (
	id_template_type int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.units (
	id_unit int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.vat (
	id_vat int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.companies (
	id_company int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.employees (
	id_employee int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
	...
	CONSTRAINT employees_fk_user FOREIGN KEY (fk_user) REFERENCES public.auth_user(id)
);
...
CREATE TABLE public.invoice_text_templates (
	id_invoice_text int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.payables (
	id_payable int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
	fk_company int4 NOT NULL,
...
CREATE TABLE public.projects (
	id_project int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.receivables (
	id_invoice int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
	invoice_date date NOT NULL,
...
CREATE TABLE public.sales (
	id_sale int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.templates (
	id_template int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
	...
	CONSTRAINT templates_fk FOREIGN KEY (fk_project) REFERENCES public.projects(id_project),
	CONSTRAINT templates_fk_1 FOREIGN KEY (fk_currency) REFERENCES public.currencies(id_currency),
	CONSTRAINT templates_fk_2 FOREIGN KEY (fk_unit) REFERENCES public.units(id_unit),
	CONSTRAINT templates_fk_3 FOREIGN KEY (fk_vat) REFERENCES public.vat(id_vat),
	CONSTRAINT templates_fk_4 FOREIGN KEY (fk_template_type) REFERENCES public.template_types(id_template_type)
);
...
CREATE TABLE public.assets (
	id_asset int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.cancellations (
	id_invoice_cancellation int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.employee_absences (
	id_employee_absence int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.tasks (
	id_task int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
...
CREATE TABLE public.asset_absences (
	id_asset_absence int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START 1 CACHE 1 NO CYCLE),
