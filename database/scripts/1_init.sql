...
CREATE TABLE public.companies (
	id_company int4 NOT NULL GENERATED BY DEFAULT AS IDENTITY( MINVALUE 0 NO MAXVALUE START 0 NO CYCLE),
...
CREATE INDEX companies_company_internal_alias_47763c3e_like ON public.companies (company_internal_alias);
CREATE INDEX companies_fk_sys_rec_status_d804c5ea ON public.companies (fk_sys_rec_status);
